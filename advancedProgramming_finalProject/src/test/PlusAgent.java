...
/**
 * Agent that adds the values of two input topics and publishes the sum.
 *
 * <p>Subscribes to {@code subs[0]} and {@code subs[1]}.  On every callback
 * the stored value for that topic is updated and the current sum
 * ({@code x + y}) is immediately published to {@code pubs[0]}.</p>
 *
...
public class PlusAgent implements Agent {
    ...
    private final String name = "PlusAgent";
    private final String[] subs;
    private final String[] pubs;

    /**
     * Creates a {@code PlusAgent}, subscribing to the first two topics in
     ...
     * current sum.  Ignores null inputs and non-numeric messages.
     *
